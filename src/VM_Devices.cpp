...
{
  if (Name == emul.Get_Name() && Path == emul.Get_Path() &&
      Default == emul.Get_Default() &&
      Check_Version == emul.Get_Check_Version() &&
      Check_Available_Options == emul.Get_Check_Available_Options() &&
      Force_Version == emul.Get_Force_Version() &&
...
bool Emulator::Load(const QString& path)
{
  ...
  if (rootElement.attribute("version") == "0.8") {
    ...
    AQWarning("bool Emulator::Load( const QString &path )",
              QString("Emulator version %1 not defined!")
                  .arg(rootElement.attribute("version")));
  }
  ...
  Check_Version =
      childElement.firstChildElement("Check_Version").text() == "yes";
  Check_Available_Options =
      childElement.firstChildElement("Check_Available_Options").text() == "yes";
  Force_Version =
      childElement.firstChildElement("Force_Version").text() == "yes";
  Version = String_To_Emulator_Version(
      childElement.firstChildElement("Version").text());
  ...
  while (iter.hasNext()) {
    ...
    if (childElement.isNull()) {
      ...
      // System
      tmpDev.System.Caption =
          childElement.firstChildElement("System_Caption").text();
      tmpDev.System.QEMU_Name =
          childElement.firstChildElement("System_QEMU_Name").text();
      ...
      if (tmpDev.Machine_List.isEmpty()) {
        AQError("bool Emulator::Load( const QString &path )",
                "No values on \"Machine_List\" element! Add default Machine "
                "element.");
      ...
      if (tmpDev.Network_Card_List.isEmpty()) {
        AQError("bool Emulator::Load( const QString &path )",
                "No values on \"Network_Card_List\" element! Add default "
      ...
      tmpDev.Audio_Card_List.Audio_sb16 =
          (thirdElement.firstChildElement("sb16").text() == "yes");
      tmpDev.Audio_Card_List.Audio_es1370 =
          (thirdElement.firstChildElement("es1370").text() == "yes");
      tmpDev.Audio_Card_List.Audio_Adlib =
          (thirdElement.firstChildElement("Adlib").text() == "yes");
      tmpDev.Audio_Card_List.Audio_PC_Speaker =
          (thirdElement.firstChildElement("PC_Speaker").text() == "yes");
      tmpDev.Audio_Card_List.Audio_GUS =
          (thirdElement.firstChildElement("GUS").text() == "yes");
      tmpDev.Audio_Card_List.Audio_AC97 =
          (thirdElement.firstChildElement("AC97").text() == "yes");
      tmpDev.Audio_Card_List.Audio_HDA =
          (thirdElement.firstChildElement("HDA").text() == "yes");
      tmpDev.Audio_Card_List.Audio_cs4231a =
          (thirdElement.firstChildElement("cs4231a").text() == "yes");
      ...
      if (tmpDev.Video_Card_List.isEmpty()) {
        AQError("bool Emulator::Load( const QString &path )",
                "No values on \"Video_Card_List\" element! Add default Video "
                "Card element.");
      ...
      bool ok = false;
      tmpDev.PSO_SMP_Count =
          childElement.firstChildElement("SMP_Count").text().toUInt(&ok);
      if (!ok) {
        AQWarning("bool Emulator::Load( const QString &path )",
      ...
      tmpDev.PSO_SMP_Cores =
          (childElement.firstChildElement("SMP_Cores").text() == "yes");
      tmpDev.PSO_SMP_Threads =
          (childElement.firstChildElement("SMP_Threads").text() == "yes");
      tmpDev.PSO_SMP_Sockets =
          (childElement.firstChildElement("SMP_Sockets").text() == "yes");
      tmpDev.PSO_SMP_MaxCPUs =
          (childElement.firstChildElement("SMP_MaxCPUs").text() == "yes");

      tmpDev.PSO_Device =
          (childElement.firstChildElement("Device").text() == "yes");
      tmpDev.PSO_Device_USB_EHCI =
          (childElement.firstChildElement("Device_USB_EHCI").text() == "yes");

      tmpDev.PSO_Drive =
          (childElement.firstChildElement("Drive").text() == "yes");
      tmpDev.PSO_Drive_File =
          (childElement.firstChildElement("Drive_File").text() == "yes");
      tmpDev.PSO_Drive_If =
          (childElement.firstChildElement("Drive_If").text() == "yes");
      tmpDev.PSO_Drive_Bus_Unit =
          (childElement.firstChildElement("Drive_Bus_Unit").text() == "yes");
      tmpDev.PSO_Drive_Index =
          (childElement.firstChildElement("Drive_Index").text() == "yes");
      tmpDev.PSO_Drive_Media =
          (childElement.firstChildElement("Drive_Media").text() == "yes");
      tmpDev.PSO_Drive_Cyls_Heads_Secs_Trans =
          (childElement.firstChildElement("Drive_Cyls_Heads_Secs_Trans")
               .text() == "yes");
      tmpDev.PSO_Drive_Snapshot =
          (childElement.firstChildElement("Drive_Snapshot").text() == "yes");
      tmpDev.PSO_Drive_Cache =
          (childElement.firstChildElement("Drive_Cache").text() == "yes");
      tmpDev.PSO_Drive_AIO =
          (childElement.firstChildElement("Drive_AIO").text() == "yes");
      tmpDev.PSO_Drive_Format =
          (childElement.firstChildElement("Drive_Format").text() == "yes");
      tmpDev.PSO_Drive_Serial =
          (childElement.firstChildElement("Drive_Serial").text() == "yes");
      tmpDev.PSO_Drive_ADDR =
          (childElement.firstChildElement("Drive_ADDR").text() == "yes");
      tmpDev.PSO_Drive_Boot =
          (childElement.firstChildElement("Drive_Boot").text() == "yes");

      tmpDev.PSO_Boot_Order =
          (childElement.firstChildElement("Boot_Order").text() == "yes");
      tmpDev.PSO_Initial_Graphic_Mode =
          (childElement.firstChildElement("Initial_Graphic_Mode").text() ==
           "yes");
      tmpDev.PSO_No_FB_Boot_Check =
          (childElement.firstChildElement("No_FB_Boot_Check").text() == "yes");
      tmpDev.PSO_Win2K_Hack =
          (childElement.firstChildElement("Win2K_Hack").text() == "yes");
      tmpDev.PSO_Kernel_KQEMU =
          (childElement.firstChildElement("Kernel_KQEMU").text() == "yes");
      tmpDev.PSO_No_ACPI =
          (childElement.firstChildElement("No_ACPI").text() == "yes");
      tmpDev.PSO_KVM = (childElement.firstChildElement("KVM").text() == "yes");
      tmpDev.PSO_RTC_TD_Hack =
          (childElement.firstChildElement("RTC_TD_Hack").text() == "yes");

      tmpDev.PSO_MTDBlock =
          (childElement.firstChildElement("MTDBlock").text() == "yes");
      tmpDev.PSO_SD = (childElement.firstChildElement("SD").text() == "yes");
      tmpDev.PSO_PFlash =
          (childElement.firstChildElement("PFlash").text() == "yes");
      tmpDev.PSO_Name =
          (childElement.firstChildElement("Name").text() == "yes");
      tmpDev.PSO_Curses =
          (childElement.firstChildElement("Curses").text() == "yes");
      tmpDev.PSO_No_Frame =
          (childElement.firstChildElement("No_Frame").text() == "yes");
      tmpDev.PSO_Alt_Grab =
          (childElement.firstChildElement("Alt_Grab").text() == "yes");
      tmpDev.PSO_No_Quit =
          (childElement.firstChildElement("No_Quit").text() == "yes");
      tmpDev.PSO_SDL = (childElement.firstChildElement("SDL").text() == "yes");
      tmpDev.PSO_Portrait =
          (childElement.firstChildElement("Portrait").text() == "yes");
      tmpDev.PSO_No_Shutdown =
          (childElement.firstChildElement("No_Shutdown").text() == "yes");
      tmpDev.PSO_Startdate =
          (childElement.firstChildElement("Startdate").text() == "yes");
      tmpDev.PSO_Show_Cursor =
          (childElement.firstChildElement("Show_Cursor").text() == "yes");
      tmpDev.PSO_Bootp =
          (childElement.firstChildElement("Bootp").text() == "yes");

      tmpDev.PSO_Net_type_vde =
          (childElement.firstChildElement("Net_type_vde").text() == "yes");
      tmpDev.PSO_Net_type_dump =
          (childElement.firstChildElement("Net_type_dump").text() == "yes");

      tmpDev.PSO_Net_name =
          (childElement.firstChildElement("Net_name").text() == "yes");
      tmpDev.PSO_Net_addr =
          (childElement.firstChildElement("Net_addr").text() == "yes");
      tmpDev.PSO_Net_vectors =
          (childElement.firstChildElement("Net_vectors").text() == "yes");

      tmpDev.PSO_Net_net =
          (childElement.firstChildElement("Net_net").text() == "yes");
      tmpDev.PSO_Net_host =
          (childElement.firstChildElement("Net_host").text() == "yes");
      tmpDev.PSO_Net_restrict =
          (childElement.firstChildElement("Net_restrict").text() == "yes");
      tmpDev.PSO_Net_dhcpstart =
          (childElement.firstChildElement("Net_dhcpstart").text() == "yes");
      tmpDev.PSO_Net_dns =
          (childElement.firstChildElement("Net_dns").text() == "yes");
      tmpDev.PSO_Net_tftp =
          (childElement.firstChildElement("Net_tftp").text() == "yes");
      tmpDev.PSO_Net_bootfile =
          (childElement.firstChildElement("Net_bootfile").text() == "yes");
      tmpDev.PSO_Net_smb =
          (childElement.firstChildElement("Net_smb").text() == "yes");
      tmpDev.PSO_Net_hostfwd =
          (childElement.firstChildElement("Net_hostfwd").text() == "yes");
      tmpDev.PSO_Net_guestfwd =
          (childElement.firstChildElement("Net_guestfwd").text() == "yes");

      tmpDev.PSO_Net_ifname =
          (childElement.firstChildElement("Net_ifname").text() == "yes");
      tmpDev.PSO_Net_bridge =
          (childElement.firstChildElement("Net_bridge").text() == "yes");
      tmpDev.PSO_Net_script =
          (childElement.firstChildElement("Net_script").text() == "yes");
      tmpDev.PSO_Net_downscript =
          (childElement.firstChildElement("Net_downscript").text() == "yes");
      tmpDev.PSO_Net_helper =
          (childElement.firstChildElement("Net_helper").text() == "yes");
      tmpDev.PSO_Net_sndbuf =
          (childElement.firstChildElement("Net_sndbuf").text() == "yes");
      tmpDev.PSO_Net_vnet_hdr =
          (childElement.firstChildElement("Net_vnet_hdr").text() == "yes");
      tmpDev.PSO_Net_vhost =
          (childElement.firstChildElement("Net_vhost").text() == "yes");
      tmpDev.PSO_Net_vhostfd =
          (childElement.firstChildElement("Net_vhostfd").text() == "yes");

      tmpDev.PSO_Net_listen =
          (childElement.firstChildElement("Net_listen").text() == "yes");
      tmpDev.PSO_Net_connect =
          (childElement.firstChildElement("Net_connect").text() == "yes");

      tmpDev.PSO_Net_mcast =
          (childElement.firstChildElement("Net_mcast").text() == "yes");

      tmpDev.PSO_Net_sock =
          (childElement.firstChildElement("Net_sock").text() == "yes");
      tmpDev.PSO_Net_port =
          (childElement.firstChildElement("Net_port").text() == "yes");
      tmpDev.PSO_Net_group =
          (childElement.firstChildElement("Net_group").text() == "yes");
      tmpDev.PSO_Net_mode =
          (childElement.firstChildElement("Net_mode").text() == "yes");

      tmpDev.PSO_Net_file =
          (childElement.firstChildElement("Net_file").text() == "yes");
      tmpDev.PSO_Net_len =
          (childElement.firstChildElement("Net_len").text() == "yes");

      tmpDev.PSO_Enable_KVM =
          (childElement.firstChildElement("Enable_KVM").text() == "yes");
      tmpDev.PSO_No_KVM =
          (childElement.firstChildElement("No_KVM").text() == "yes");
      tmpDev.PSO_No_KVM_IRQChip =
          (childElement.firstChildElement("No_KVM_IRQChip").text() == "yes");
      tmpDev.PSO_No_KVM_Pit =
          (childElement.firstChildElement("No_KVM_Pit").text() == "yes");
      tmpDev.PSO_No_KVM_Pit_Reinjection =
          (childElement.firstChildElement("No_KVM_Pit_Reinjection").text() ==
           "yes");
      tmpDev.PSO_Enable_Nesting =
          (childElement.firstChildElement("Enable_Nesting").text() == "yes");
      tmpDev.PSO_KVM_Shadow_Memory =
          (childElement.firstChildElement("KVM_Shadow_Memory").text() == "yes");

      tmpDev.PSO_SPICE =
          (childElement.firstChildElement("SPICE").text() == "yes");
      tmpDev.PSO_QXL = (childElement.firstChildElement("QXL").text() == "yes");

      tmpDev.PSO_TFTP =
          (childElement.firstChildElement("TFTP").text() == "yes");
      tmpDev.PSO_SMB = (childElement.firstChildElement("SMB").text() == "yes");
      tmpDev.PSO_Std_VGA =
          (childElement.firstChildElement("Std_VGA").text() == "yes");
...
bool Emulator::Save() const
{
  ...
  domDocument.appendChild(domDocument.createProcessingInstruction(
  ...
  emulatorElement.appendChild(domElement);
  domText =
      domDocument.createTextNode((Check_Available_Options ? "yes" : "no"));
  domElement.appendChild(domText);
  ...
  if (emulatorVersion.isEmpty()) {
    ...
    domText = domDocument.createTextNode(emulatorVersion);
  ...
  QMap<QString, QString>::const_iterator binFilesIter =
      Binary_Files.constBegin();
  ...
  // Save devices
  QMap<QString, Available_Devices>::const_iterator devicesIter =
      Devices.constBegin();
  while (devicesIter != Devices.constEnd()) {
    ...
    for (int ix = 0; ix < tmpDev.Network_Card_List.count(); ix++) {
      thirdElement = domDocument.createElement(QString("Caption%1").arg(ix));
      domText =
          domDocument.createTextNode(tmpDev.Network_Card_List[ix].Caption);
      thirdElement.appendChild(domText);
      deviceElement.appendChild(thirdElement);

      thirdElement = domDocument.createElement(QString("Name%1").arg(ix));
      domText =
          domDocument.createTextNode(tmpDev.Network_Card_List[ix].QEMU_Name);
      thirdElement.appendChild(domText);
      deviceElement.appendChild(thirdElement);
    }
    domElement.appendChild(deviceElement);
    ...
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_sb16 ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);

    thirdElement = domDocument.createElement("es1370");
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_es1370 ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);

    thirdElement = domDocument.createElement("Adlib");
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_Adlib ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);

    thirdElement = domDocument.createElement("PC_Speaker");
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_PC_Speaker ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);

    thirdElement = domDocument.createElement("GUS");
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_GUS ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);

    thirdElement = domDocument.createElement("AC97");
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_AC97 ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);

    thirdElement = domDocument.createElement("HDA");
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_HDA ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);

    thirdElement = domDocument.createElement("cs4231a");
    domText = domDocument.createTextNode(
        (tmpDev.Audio_Card_List.Audio_cs4231a ? "yes" : "no"));
    thirdElement.appendChild(domText);
    deviceElement.appendChild(thirdElement);
    ...
    for (int ix = 0; ix < tmpDev.Video_Card_List.count(); ix++) {
      ...
      thirdElement = domDocument.createElement(QString("Name%1").arg(ix));
      domText =
          domDocument.createTextNode(tmpDev.Video_Card_List[ix].QEMU_Name);
      thirdElement.appendChild(domText);
      deviceElement.appendChild(thirdElement);
    }
    domElement.appendChild(deviceElement);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_SMP_Threads ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_SMP_Sockets ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_SMP_MaxCPUs ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Device_USB_EHCI ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_File ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Bus_Unit ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Index ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Media ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText = domDocument.createTextNode(
        (tmpDev.PSO_Drive_Cyls_Heads_Secs_Trans ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Snapshot ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Cache ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Format ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Serial ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_ADDR ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Drive_Boot ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Boot_Order ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText = domDocument.createTextNode(
        (tmpDev.PSO_Initial_Graphic_Mode ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText = domDocument.createTextNode(
        (tmpDev.PSO_No_FB_Boot_Check ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Win2K_Hack ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Kernel_KQEMU ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_RTC_TD_Hack ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_No_Shutdown ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Show_Cursor ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_type_vde ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_type_dump ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_vectors ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_restrict ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_dhcpstart ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_bootfile ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_hostfwd ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_guestfwd ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_ifname ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_bridge ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_script ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_downscript ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_helper ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_sndbuf ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_vnet_hdr ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_vhostfd ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_listen ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Net_connect ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Enable_KVM ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_No_KVM_IRQChip ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_No_KVM_Pit ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText = domDocument.createTextNode(
        (tmpDev.PSO_No_KVM_Pit_Reinjection ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText =
        domDocument.createTextNode((tmpDev.PSO_Enable_Nesting ? "yes" : "no"));
    deviceElement.appendChild(domText);
    ...
    domElement.appendChild(deviceElement);
    domText = domDocument.createTextNode(
        (tmpDev.PSO_KVM_Shadow_Memory ? "yes" : "no"));
    deviceElement.appendChild(domText);
...
const QMap<QString, Available_Devices>& Emulator::Get_Devices() const
{
  if (Force_Version || Check_Version) {
    switch (Version) {
      ...
      default:
        AQError(
            "const QMap<QString, Available_Devices> &Emulator::Get_Devices() "
            "const",
...
VM_Native_Storage_Device::VM_Native_Storage_Device(
    const VM_Native_Storage_Device& sd)
{
...
bool VM_Native_Storage_Device::operator==(
    const VM_Native_Storage_Device& sd) const
{
  if (UFile_Path == sd.Use_File_Path() && File_Path == sd.Get_File_Path() &&
      UInterface == sd.Use_Interface() && Interface == sd.Get_Interface() &&
      UBus_Unit == sd.Use_Bus_Unit() && Bus == sd.Get_Bus() &&
      Unit == sd.Get_Unit() && UIndex == sd.Use_Index() &&
      Index == sd.Get_Index() && UMedia == sd.Use_Media() &&
      Media == sd.Get_Media() && Uhdachs == sd.Use_hdachs() &&
      Cyls == sd.Get_Cyls() && Heads == sd.Get_Heads() &&
      Secs == sd.Get_Secs() && Trans == sd.Get_Trans() &&
      USnapshot == sd.Use_Snapshot() && Snapshot == sd.Get_Snapshot() &&
      UCache == sd.Use_Cache() && Cache == sd.Get_Cache() &&
      UAIO == sd.Use_AIO() && AIO == sd.Get_AIO() && UBoot == sd.Use_Boot() &&
      Boot == sd.Get_Boot() && UDiscard == sd.Use_Discard() &&
      Discard == sd.Get_Discard()) {
    return true;
  }
  else {
...
{
  if (Enabled == device.Get_Enabled() && File_Name == device.Get_File_Name() &&
      Native_Device == device.Get_Native_Device()) {
    return true;
  }
  else
...
void VM_Storage_Device::Set_Native_Device(
    const VM_Native_Storage_Device& device)
{
...
{
  if (Enabled == folder.Get_Enabled() && Folder == folder.Get_Folder()) {
    return true;
  }
  else
    return false;
...
{
  return QString::number(Virtual_Size.Size) +
         Size_Suffix_to_String(Virtual_Size.Suffix);
}

QString VM_HDD::Get_Complete_Disk_Size() const
{
  return QString::number(Disk_Size.Size) +
         Size_Suffix_to_String(Disk_Size.Suffix);
}
...
VM::Device_Size VM_HDD::String_to_Device_Size(const QString& size) const
{
  ...
  if (size.isEmpty()) {
    AQDebug(
        "VM::Device_Size VM_HDD::String_to_Device_Size( const QString &size ) "
        "const",
...
{
  if (Tag == s.Get_Tag() && ID == s.Get_ID() && Size == s.Get_Size() &&
      Date == s.Get_Date() && VM_Clock == s.Get_VM_Clock() &&
      Name == s.Get_Name() && Description == s.Get_Description()) {
    return true;
  }
  else {
    return false;
...
bool VM_Net_Card_Native::operator==(const VM_Net_Card_Native& nc) const
{
  if (Network_Mode == nc.Get_Network_Type() &&
      Card_Model == nc.Get_Card_Model() && MAC == nc.Get_MAC_Address() &&
      VLAN == nc.Get_VLAN() && Name == nc.Get_Name() &&
      Hostname == nc.Get_Hostname() && PortDev == nc.Get_PortDev() &&
      File_Descriptor == nc.Get_File_Descriptor() &&
      Interface_Name == nc.Get_Interface_Name() &&
      Bridge_Name == nc.Get_Bridge_Name() &&
      TUN_TAP_Script == nc.Get_TUN_TAP_Script() &&
      TUN_TAP_Down_Script == nc.Get_TUN_TAP_Down_Script() &&
      Bridge_Helper == nc.Get_Bridge_Helper() && Listen == nc.Get_Listen() &&
      Connect == nc.Get_Connect() && MCast == nc.Get_MCast() &&
      Sock == nc.Get_Sock() && Port == nc.Get_Port() &&
      Group == nc.Get_Group() && Mode == nc.Get_Mode() &&
      File == nc.Get_File() && Len == nc.Get_Len() && Addr == nc.Get_Addr() &&
      Vectors == nc.Get_Vectors() && Net == nc.Get_Net() &&
      Host == nc.Get_Host() && Restrict == nc.Get_Restrict() &&
      DHCPstart == nc.Get_DHCPstart() && DNS == nc.Get_DNS() &&
      Tftp == nc.Get_Tftp() && Bootfile == nc.Get_Bootfile() &&
      HostFwd == nc.Get_HostFwd() && GuestFwd == nc.Get_GuestFwd() &&
      SMB == nc.Get_SMB() && SMBserver == nc.Get_SMBserver() &&
      Sndbuf == nc.Get_Sndbuf() && VNet_hdr == nc.Get_VNet_hdr() &&
      VHost == nc.Get_VHost() && VHostFd == nc.Get_VHostFd() &&
      _Use_MAC == nc.Use_MAC_Address() && _Use_VLAN == nc.Use_VLAN() &&
      _Use_Name == nc.Use_Name() && _Use_Hostname == nc.Use_Hostname() &&
      _Use_File_Descriptor == nc.Use_File_Descriptor() &&
      _Use_Interface_Name == nc.Use_Interface_Name() &&
      _Use_Bridge_Name == nc.Use_Bridge_Name() &&
      _Use_TUN_TAP_Script == nc.Use_TUN_TAP_Script() &&
      _Use_TUN_TAP_Down_Script == nc.Use_TUN_TAP_Down_Script() &&
      _Use_Bridge_Helper == nc.Use_Bridge_Helper() &&
      _Use_Listen == nc.Use_Listen() && _Use_Connect == nc.Use_Connect() &&
      _Use_MCast == nc.Use_MCast() && _Use_Sock == nc.Use_Sock() &&
      _Use_Port == nc.Use_Port() && _Use_Group == nc.Use_Group() &&
      _Use_Mode == nc.Use_Mode() && _Use_File == nc.Use_File() &&
      _Use_Len == nc.Use_Len() && _Use_Addr == nc.Use_Addr() &&
      _Use_Vectors == nc.Use_Vectors() && _Use_Net == nc.Use_Net() &&
      _Use_Host == nc.Use_Host() && _Use_Restrict == nc.Use_Restrict() &&
      _Use_DHCPstart == nc.Use_DHCPstart() && _Use_DNS == nc.Use_DNS() &&
      _Use_Tftp == nc.Use_Tftp() && _Use_Bootfile == nc.Use_Bootfile() &&
      _Use_HostFwd == nc.Use_HostFwd() && _Use_GuestFwd == nc.Use_GuestFwd() &&
      _Use_SMB == nc.Use_SMB() && _Use_SMBserver == nc.Use_SMBserver() &&
      _Use_Sndbuf == nc.Use_Sndbuf() && _Use_VNet_hdr == nc.Use_VNet_hdr() &&
      _Use_VHost == nc.Use_VHost() && _Use_VHostFd == nc.Use_VHostFd()) {
    return true;
  }
  else {
    return false;
...
{
  if (Card_Model == nc.Get_Card_Model() && Net_Mode == nc.Get_Net_Mode() &&
      Hostname == nc.Get_Hostname() && IP == nc.Get_IP_Address() &&
      MAC == nc.Get_MAC_Address() && Port == nc.Get_Port() &&
      VLAN == nc.Get_VLAN() &&
      Use_TUN_TAP_Script == nc.Get_Use_TUN_TAP_Script() &&
      TUN_TAP_Script == nc.Get_TUN_TAP_Script() &&
      Interface_Name == nc.Get_Interface_Name() &&
...
QString VM_Net_Card::Generate_MAC() const
{
  ...
  else  // Default. Valid Card MAC
  {
    ...
    if (model == "ne2k_pci" || model == "ne2k_isa") {
      ...
      if (rm >= 0 && rm < novell_mac.count())
        nmac.prepend(novell_mac[rm]);
    }
    else if (model == "i82551" || model == "i82557b" || model == "i82559er" ||
             model == "e1000") {
      int rm = Get_Random(0, 4);
      if (rm >= 0 && rm < intel_mac.count())
        nmac.prepend(intel_mac[rm]);
    }
    else if (model == "pcnet") {
      int rm = Get_Random(0, 1);
      if (rm >= 0)
        nmac.prepend(amd_mac[rm]);
    }
      ...
      int rm = Get_Random(0, 4);
      if (rm >= 0)
        nmac.prepend(smc_mac[rm]);
    }
    else if (model == "mcf_fec") {
      int rm = Get_Random(0, 4);
      if (rm >= 0)
        nmac.prepend(motorola_mac[rm]);
    }
    else if (model == "lance") {
      int rm = Get_Random(0, 4);
      if (rm >= 0)
        nmac.prepend(sun_mac[rm]);
    }
    else if (model == "fseth") {
...
{
  if (Protocol == r.Get_Protocol() && Host_Port == r.Get_Host_Port() &&
      Guest_IP == r.Get_Guest_IP() && Guest_Port == r.Get_Guest_Port()) {
    return true;
  }
  else {
    return false;
...
VM_USB::VM_USB(const VM_USB& u)
{
  ...
  Speed = u.Get_Speed();
  u.Get_USB_QEMU_Devices(USB_Keyboard, USB_Mouse, USB_Tablet, USB_WacomTablet,
                         USB_Braille);
}
...
bool VM_USB::operator==(const VM_USB& u) const
{
  ...
  if (Use_Host_Device == u.Get_Use_Host_Device() &&
      Vendor_ID == u.Get_Vendor_ID() && Product_ID == u.Get_Product_ID() &&
      Serial_Number == u.Get_Serial_Number() && USB_Keyboard == k &&
      USB_Mouse == m && USB_Tablet == t && USB_WacomTablet == wt &&
      USB_Braille == b) {
    return true;
  }
  else
...
void VM_USB::Get_USB_QEMU_Devices(bool& keyboard, bool& mouse, bool& tablet,
                                  bool& wacomTablet, bool& braille) const
{
...
void VM_USB::Set_USB_QEMU_Devices(bool keyboard, bool mouse, bool tablet,
                                  bool wacomTablet, bool braille)
{
...
{
  if (Enabled == mode.Get_Enabled() && Width == mode.Get_Width() &&
      Height == mode.Get_Height() && Depth == mode.Get_Depth()) {
    return true;
  }
  else {
    return false;
...
VM_SPICE::VM_SPICE()
{
  ...
  _Use_Renderer = false;
  Renderer_List << VM::SPICE_Renderer_cairo << VM::SPICE_Renderer_oglpbuf
...
bool VM_SPICE::operator==(const VM_SPICE& vm_spice) const
{
  if (Enable_SPICE == vm_spice.Use_SPICE() &&
      GXL_Devices_Count == vm_spice.Get_GXL_Devices_Count() &&
      RAM_Size == vm_spice.Get_RAM_Size() && Port == vm_spice.Get_Port() &&
      _Use_SPort == vm_spice.Use_SPort() && SPort == vm_spice.Get_SPort() &&
      _Use_Hostname == vm_spice.Use_Hostname() &&
      Hostname == vm_spice.Get_Hostname() &&
      _Use_Image_Compression == vm_spice.Use_Image_Compression() &&
      Image_Compression == vm_spice.Get_Image_Compression() &&
      _Use_Video_Stream_Compression ==
          vm_spice.Use_Video_Stream_Compression() &&
      _Use_Renderer == vm_spice.Use_Renderer() &&
      Renderer_List == vm_spice.Get_Renderer_List() &&
      _Use_Playback_Compression == vm_spice.Use_Playback_Compression() &&
      _Use_Password == vm_spice.Use_Password() &&
