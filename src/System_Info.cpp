...
bool System_Info::Update_VM_Computers_List()
{
  ...
  Machine_ARM << Device_Map(QObject::tr("Integrator/CP (ARM926EJ-S)"),
                            "integratorcp926");
  Machine_ARM << Device_Map(QObject::tr("Integrator/CP (ARM1026EJ-S)"),
                            "integratorcp1026");
  Machine_ARM << Device_Map(QObject::tr("Versatile/PB (ARM926EJ-S)"),
                            "versatilepb");
  Machine_ARM << Device_Map(QObject::tr("Versatile/AB (ARM926EJ-S)"),
                            "versatileab");
  ...
  Machine_Sparc << Device_Map(QObject::tr("SPARCserver 600MP (Sun4m)"),
                              "SS-600MP");
  Machine_Sparc << Device_Map(QObject::tr("SPARCserver 1000 (Sun4d)"),
                              "SS-1000");
  Machine_Sparc << Device_Map(QObject::tr("SPARCcenter 2000 (Sun4d)"),
                              "SS-2000");
  ...
  QEMU_Video_Cards_v0_10_0 << Device_Map(QObject::tr("StdVGA (VESA 2.0)"),
                                         "std");
  QEMU_Video_Cards_v0_10_0 << Device_Map(QObject::tr("Cirrus CLGD 5446"),
                                         "cirrus");
  QEMU_Video_Cards_v0_10_0 << Device_Map(QObject::tr("VMWare Video Card"),
                                         "vmware");
  QEMU_Video_Cards_v0_10_0 << Device_Map(QObject::tr("None Video Card"),
                                         "none");
  ...
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Integrator/CP (ARM926EJ-S)"),
                                   "integratorcp");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Versatile/PB (ARM926EJ-S)"),
                                   "versatilepb");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Versatile/AB (ARM926EJ-S)"),
                                   "versatileab");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("RealView (ARM926EJ-S)"),
                                   "realview");
  ...
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Borzoi PDA (PXA270)"),
                                   "borzoi");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Terrier PDA (PXA270)"),
                                   "terrier");

  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Siemens SX1 (OMAP310) V1"),
                                   "sx1-v1");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Siemens SX1 (OMAP310) V2"),
                                   "sx1");

  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Palm Tungsten (OMAP310)"),
                                   "cheetah");

  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Nokia N800"), "n800");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Nokia N810"), "n810");

  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Stellaris LM3S811EVB"),
                                   "lm3s811evb");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Stellaris LM3S6965EVB"),
                                   "lm3s6965evb");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Gumstix Connex (PXA255)"),
                                   "connex");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Gumstix Verdex (PXA270)"),
                                   "verdex");
  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Mainstone II (PXA27x)"),
                                   "mainstone");

  Machine_ARM_0_10_0 << Device_Map(QObject::tr("Marvell 88w8618 / MusicPal"),
                                   "musicpal");
  ...
  ad.Machine_List << Device_Map(QObject::tr("Bare ETRAX FS board"),
                                "bareetraxfs");
  ...
  MIPS_CPU_64Bit << Device_Map(QObject::tr("MIPS MIPS64R2-generic"),
                               "MIPS64R2-generic");
  ...
  ad.Machine_List << Device_Map(QObject::tr("Spartan 3ADSP1800"),
                                "petalogix-s3adsp1800");
  ad.Network_Card_List << Device_Map(QObject::tr("xilinx-ethlite"),
                                     "xilinx-ethlite");
  ad.Video_Card_List += QEMU_Video_Cards_v0_10_0;
  ...
  Machine_PPC_0_10_0 << Device_Map(QObject::tr("Mac99 based PowerMAC"),
                                   "mac99");
  Machine_PPC_0_10_0 << Device_Map(QObject::tr("PowerPC PREP platform"),
                                   "prep");
  ...
  ad.Machine_List << Device_Map(QObject::tr("SPARCstation Voyager (Sun4m)"),
                                "Voyager");
  ...
  ad.Machine_List << Device_Map(QObject::tr("SPARCClassic (Sun4m)"),
                                "SPARCClassic");
...
VM::Emulator_Version System_Info::Get_Emulator_Version(const QString& path)
{
  if (path.isEmpty()) {
    AQWarning(
        "VM::Emulator_Version System_Info::Get_Emulator_Version( const QString "
        "&path )",
        "path is Empty");
    return VM::Obsolete;
  }
  ...
  for (int ix = 0; ix < 5; ++ix) {
    ...
    if (tmpLine.isEmpty()) {
      AQError(
          "VM::Emulator_Version System_Info::Get_Emulator_Version( const "
          "QString &path )",
  ...
  else  // Version like: 1.0
  {
    ...
    if (major_ver > 1 || (major_ver == 1 && minor_ver > 0)) {
      ...
      AQError(
          "VM::Emulator_Version System_Info::Get_Emulator_Version( const "
          "QString &path )",
          QString("QEMU Version %1.%2 not defined!")
              .arg(major_ver)
              .arg(minor_ver));
      return VM::Obsolete;
    }
...
QMap<QString, QString> System_Info::Find_QEMU_Binary_Files(const QString& path)
{
  ...
  if (!QFile::exists(path)) {
    AQError(
        "QMap<QString, QString> System_Info::Find_QEMU_Binary_Files( const "
        "QString &path )",
...
#ifdef Q_OS_WIN32
    if (QFile::exists(dirPath + iter.key() + ".exe"))
      iter.value() = dirPath + iter.key() + ".exe";
#else
    if (QFile::exists(dirPath + iter.key()))
...
QString System_Info::Find_IMG(const QStringList& paths)
{
  ...
  for (int ix = 0; ix < paths.count(); ++ix) {
    QString dirPath = QDir::toNativeSeparators(
        (paths[ix].endsWith("/") || paths[ix].endsWith("\\"))
            ? paths[ix]
            : paths[ix] + "/");

    if (QFile::exists(dirPath + "qemu-img"))
      return dirPath + "qemu-img";
    else if (QFile::exists(dirPath + "kvm-img"))
      return dirPath + "kvm-img";
  }
                                                 ...
                                                 const QString& internalName)
{
  if (!QFile::exists(path)) {
    AQError(
        "Available_Devices System_Info::Get_Emulator_Info( const QString "
        "&path, bool *ok,"
  ...
  if (rx.match(all_help).hasMatch()) {
    ...
    if (internalName == "qemu-system-x86_64")
      tmp_dev.PSO_SMP_Count = 255;
    else if (internalName == "qemu-system-sparc")
      tmp_dev.PSO_SMP_Count = 4;

    if (rx.match(all_help).hasMatch()) {
      if (rx.match(all_help).capturedTexts().count() > 1) {
        if (rx.match(all_help).capturedTexts()[1].indexOf("cores") != -1)
          tmp_dev.PSO_SMP_Cores = true;
        if (rx.match(all_help).capturedTexts()[1].indexOf("threads") != -1)
          tmp_dev.PSO_SMP_Threads = true;
        if (rx.match(all_help).capturedTexts()[1].indexOf("sockets") != -1)
          tmp_dev.PSO_SMP_Sockets = true;
        if (rx.match(all_help).capturedTexts()[1].indexOf("maxcpus") != -1)
          tmp_dev.PSO_SMP_MaxCPUs = true;
      }
    }
  }

  // -device
  rx = QRegularExpression(".*-device\\s.*");
  if (rx.match(all_help).hasMatch()) {
    ...
    rx = QRegularExpression(".*usb\\-ehci.*");
    if (rx.match(emulDevList).hasMatch())
      tmp_dev.PSO_Device_USB_EHCI = true;

    // Find usb-xhci support (USB 3.0)
    rx = QRegularExpression(".*usb\\-xhci.*");
    if (rx.match(emulDevList).hasMatch())
      tmp_dev.PSO_Device_USB_XHCI = true;
  }

  // -drive
  rx = QRegularExpression(".*-drive\\s+(\\[.*\\]).*-.*");
  if (rx.match(all_help).hasMatch()) {
    ...
    if (rx_list.count() > 1) {
      ...
      if (drive_str.indexOf("file=") != -1)
        tmp_dev.PSO_Drive_File = true;
      if (drive_str.indexOf("if=") != -1)
        tmp_dev.PSO_Drive_If = true;
      if (drive_str.indexOf("bus=") != -1)
        tmp_dev.PSO_Drive_Bus_Unit = true;
      if (drive_str.indexOf("index=") != -1)
        tmp_dev.PSO_Drive_Index = true;
      if (drive_str.indexOf("media=") != -1)
        tmp_dev.PSO_Drive_Media = true;
      if (drive_str.indexOf("cyls=") != -1)
        tmp_dev.PSO_Drive_Cyls_Heads_Secs_Trans = true;
      if (drive_str.indexOf("snapshot=") != -1)
        tmp_dev.PSO_Drive_Snapshot = true;
      if (drive_str.indexOf("cache=") != -1)
        tmp_dev.PSO_Drive_Cache = true;
      if (drive_str.indexOf("aio=") != -1)
        tmp_dev.PSO_Drive_AIO = true;
      if (drive_str.indexOf("format=") != -1)
        tmp_dev.PSO_Drive_Format = true;
      if (drive_str.indexOf("serial=") != -1)
        tmp_dev.PSO_Drive_Serial = true;
      if (drive_str.indexOf("addr=") != -1)
        tmp_dev.PSO_Drive_ADDR = true;
      if (drive_str.indexOf("boot=") != -1)
        tmp_dev.PSO_Drive_Boot = true;
    }
  }

  // -boot [order=drives][,once=drives][,menu=on|off]
  rx = QRegularExpression(".*-boot\\s+\\[order.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Boot_Order = true;

  // -g WxH[xDEPTH]
  rx = QRegularExpression(".*-g\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Initial_Graphic_Mode = true;

  // -no-fd-bootchk
  rx = QRegularExpression(".*-no-fd-bootchk\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_No_FB_Boot_Check = true;

  // -win2k-hack
  rx = QRegularExpression(".*-win2k-hack\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Win2K_Hack = true;

  // -no-acpi
  rx = QRegularExpression(".*-no-acpi\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_No_ACPI = true;

  // (old option -rtc-td-hack) -rtc *,drift=slew
  rx = QRegularExpression(".*-rtc\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_RTC_TD_Hack = true;

  // -mtdblock
  rx = QRegularExpression(".*-mtdblock\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_MTDBlock = true;

  // -sd
  rx = QRegularExpression(".*-sd\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_SD = true;

  // -pflash
  rx = QRegularExpression(".*-pflash\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_PFlash = true;

  // -name
  rx = QRegularExpression(".*-name\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Name = true;

  // -curses
  rx = QRegularExpression(".*-curses\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Curses = true;

  // -no-frame
  rx = QRegularExpression(".*-no-frame\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_No_Frame = true;

  // -alt-grab
  rx = QRegularExpression(".*-alt-grab\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Alt_Grab = true;

  // -no-quit
  rx = QRegularExpression(".*-no-quit\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_No_Quit = true;

  // -sdl
  rx = QRegularExpression(".*-sdl\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_SDL = true;

  // -portrait
  rx = QRegularExpression(".*-portrait\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Portrait = true;

  // -no-shutdown
  rx = QRegularExpression(".*-no-shutdown\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_No_Shutdown = true;

  // (old -startdate option) -rtc base=date
  rx = QRegularExpression(".*-rtc\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Startdate = true;

  // -show-cursor
  rx = QRegularExpression(".*-show-cursor\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Show_Cursor = true;

  // -bootp
  rx = QRegularExpression(".*-bootp\\s.*");
  if (rx.match(all_help).hasMatch())
    tmp_dev.PSO_Bootp = true;

  // -netdev
  QString net_str = "";
  rx = QRegularExpression(".*(-netdev\\s+.*)-net.*");
  if (rx.match(all_help).hasMatch()) {
    QStringList rx_list = rx.match(all_help).capturedTexts();
  ...
  if (tmp_dev.PSO_Net_tftp ==
      true) {  // hack, all this code should probably be rewritten or removed
  ...
  do {
    ...
    if (tmp.indexOf("Available CPUs") != -1)
      continue;
    if (tmp.indexOf("Sparc") != -1)
      break;  // FIXME Sparc -cpu not supported in this release

    QStringList regExpVariants;
    regExpVariants
        << ".*x86\\s+([\\w-]+).*|.*x86\\s+\\[([\\w-]+)\\].*"  // x86 pentium3 | x86 [core2duo]
    ...
    if (!(qemu_dev_name.isEmpty() ||
          qemu_dev_name.indexOf(QRegularExpression("/^\\S+$/"), 0) != -1)) {
  ...
  if (tmp_dev.CPU_List.count() < 2) {
    ...
    AQWarning(
        ...
        "&path, bool *ok,"
        "VM::Emulator_Version version, const QString &internalName )",
        QString("Cannot get CPU's info from emulator \"%1\". Use default list")
            .arg(path));
  }
  ...
  do {
    ...
    // This description?
    if (tmp.startsWith("Supported machines are"))
      continue;
    ...
    if (!(dev_map.QEMU_Name.isEmpty() ||
          dev_map.QEMU_Name.indexOf(QRegularExpression("/^\\S+$/"), 0) != -1)) {
  ...
  if (tmp_dev.Machine_List.count() < 2) {
    ...
    AQWarning(
        ...
        "VM::Emulator_Version version, const QString &internalName )",
        QString(
            "Cannot get machines info from emulator \"%1\". Use default list")
            .arg(path));
  }
  ...
  do {
    ...
    if (vga_list_string.startsWith("-vga"))
      break;
  ...
  if (rx.match(vga_list_string).hasMatch()) {
    ...
    if (rx.match(vga_list_string).capturedTexts().count() > 1) {
      QStringList vga_devices_list = rx.match(vga_list_string)
                                         .capturedTexts()[1]
      ...
      if (vga_devices_list.isEmpty()) {
        AQError(
            ...
            "&path, bool *ok,"
            "VM::Emulator_Version version, const QString &internalName )",
            "VGA Devices List is Empty. Data is: \"" +
                rx.match(vga_list_string).capturedTexts()[0] + "\"");
      }
      else {
        for (int gx = 0; gx < vga_devices_list.count(); gx++) {
          ...
          for (int ix = 0; ix < default_device.Video_Card_List.count(); ix++) {
            if (vga_devices_list[gx] ==
                default_device.Video_Card_List[ix].QEMU_Name) {
          ...
          // No this device name in default list
          if (vga_found == false)
            tmp_dev.Video_Card_List
                << Device_Map(vga_devices_list[gx], vga_devices_list[gx]);
        }
      }
    }
    else {
      AQError(
          ...
          "&path, bool *ok,"
          "VM::Emulator_Version version, const QString &internalName )",
          "Cannot parse VGA string regExp. Data is: \"" +
              rx.match(vga_list_string).capturedTexts()[0] + "\"");
    }
  }
  ...
  do {
    ...
    if (tmp.contains("not supported"))
      break;

    // This description?
    if (tmp.isEmpty() || tmp.startsWith("Valid sound card names") ||
        tmp.startsWith("-soundhw") ||
        tmp.indexOf(QRegularExpression("/^\\S+$/"), 0) != -1)
      continue;
  ...
  do {
    ...
    // This description?
    if (tmp.indexOf("models:") == -1)
      continue;

    // Get all models string
    QString all_models =
        tmp.mid(tmp.indexOf("models:") + QString("models:").size(), tmp.size());
    ...
    for (int ax = 0; ax < net_cards_models.count(); ax++) {
      ...
      // No this device name in default list
      if (net_found == false)
        tmp_dev.Network_Card_List << Device_Map(net_dev_str, net_dev_str);
    }
  ...
  if (tmp_dev.Network_Card_List.count() < 2) {
    tmp_dev.Network_Card_List =
        default_device.Network_Card_List;  // FIXME Emul Version
    AQWarning(
        "Available_Devices System_Info::Get_Emulator_Info( const QString "
        "&path, bool *ok,"
        "VM::Emulator_Version version, const QString &internalName )",
        QString(
            "Cannot get net cards info from emulator \"%1\". Use default list")
            .arg(path));
  }

  // Return info
  AQDebug(
      "Available_Devices System_Info::Get_Emulator_Info( const QString &path, "
      "bool *ok,"
      "VM::Emulator_Version version, const QString &internalName )",
      "Done");
  *ok = true;
...
QString System_Info::Get_Emulator_Output(const QString& path,
                                         const QStringList& args)
{
  ...
  if (!qemu_pr->waitForFinished(2000)) {
    AQError(
        "QStringList System_Info::Get_Emulator_Output( const QString &path, "
        "const QStringList &args )",
        QString("Time left. File: \"%1\" Args: \"%1\"")
            .arg(path)
            .arg(args.join(" ")));
  ...
  result +=
      qemu_pr->readAllStandardError();  // readAll() not read cerr messages...
  delete qemu_pr;
...
bool System_Info::Scan_USB_Sys(QList<VM_USB>& list)
{
  ...
  QStringList all_usb_dirs =
      dir.entryList(QStringList("*"), QDir::Dirs, QDir::Name);
  ...
  auto re_NumNumNum =
      QRegularExpression("^\\d+[-]\\d+[.]\\d+$");  // like: 1-2.1
...
bool System_Info::Scan_USB_Proc(QList<VM_USB>& list)
{
  ...
  if (!proc_file.open(QIODevice::ReadOnly | QIODevice::Text)) {
    AQError("bool System_Info::Scan_USB_Proc( QList<VM_USB> &list )",
            "Cannot Open File \"/proc/bus/usb/devices\"! USB information not "
            "found!");
    return false;
  }
  ...
  while (!line.isNull()) {
    ...
    if (line.startsWith("T:")) {
      ...
      while (!in.atEnd()) {
        ...
        if (line.startsWith("P:") || line.startsWith("S:  Manufacturer") ||
            line.startsWith("S:  Product") ||
            line.startsWith("S:  SerialNumber"))
          tmp_str << line;
  ...
  auto busAddr = QRegularExpression(
      "T:[\\s]+Bus=([\\d]{2}).+Dev#=[\\s]*([\\d]+).+Spd=([\\d]{1,3}).*");

  // P:  Vendor=0123 ProdID=abcd Rev= 0.01
  auto idHex = QRegularExpression(
      "P:[\\s]+Vendor=([\\dabcdef]{4})[\\s]+ProdID=([\\dabcdef]{4}).+");
    ...
    for (int bx = 0; bx < linux_usb_dev[ix].count(); bx++) {
      ...
      if (manufacturer_list.count() <= 0) {
        if (manufacturer.match(linux_usb_dev[ix][bx]).hasMatch()) {
          manufacturer_list =
              manufacturer.match(linux_usb_dev[ix][bx]).capturedTexts();
          continue;
        }
        else {
          AQError(
      ...
      if (serialNumber_list.count() <= 0) {
        if (serialNumber.match(linux_usb_dev[ix][bx]).hasMatch()) {
          serialNumber_list =
              serialNumber.match(linux_usb_dev[ix][bx]).capturedTexts();
          continue;
        }
        else {
          AQError(
    ...
    if (idHex_list.count() > 1) {
      if (idHex_list[1] != "0000" && idHex_list[2] != "0000") {
        ...
        if (busAddr_list.count() >= 3) {
          QString busStr = (busAddr_list[1][0] == '0')
                               ? QString(busAddr_list[1][1])
                               : busAddr_list[1];
...
void System_Info::Get_Free_Memory_Size(int& allRAM, int& freeRAM)
{
  ...
  if (QFile::exists("/proc/meminfo")) {
    ...
    if (!proc_file.open(QIODevice::ReadOnly | QIODevice::Text)) {
      ...
      while (!line.isNull()) {
        if ((all_mem != -1) && (free_mem != -1) && (cached_mem != -1) &&
            (buf_mem != -1)) {
  ...
  allRAM = (int)(unsigned long)(sysInfo.totalram * sysInfo.mem_unit) / 1024.0 /
           1024.0;
  freeRAM = (int)(unsigned long)((sysInfo.freeram + sysInfo.bufferram) *
                                 sysInfo.mem_unit) /
            1024.0 / 1024.0;
}
...
QStringList System_Info::Get_Host_FDD_List()
{
  ...
  QFileInfoList devices =
      dev_dir.entryInfoList(QStringList("fd*"), QDir::System, QDir::Name);
...
QStringList System_Info::Get_Host_CDROM_List()
{
  ...
  QFileInfoList devices =
      dev_dir.entryInfoList(name_filters, QDir::System, QDir::Name);
  ...
  for (int ix = 0; ix < cdrom_count; ix++) {
    tmp_list << settings
                    .value(
                        "Additional_CDROM_Devices/Device" + QString::number(ix),
                        "")
                    .toString();
  }
...
void System_Info::Get_Free_Memory_Size(int& allRAM, int& freeRAM)
{
  ...
  if ((sysctlbyname("vm.stats.vm.v_page_count", &all_ram, &len, NULL, 0) ==
       -1) ||
      !len) {
    all_ram = 0;
    AQError(
  ...
  if ((sysctlbyname("vm.stats.vm.v_free_count", &free_ram, &len, NULL, 0) ==
       -1) ||
      !len) {
    free_ram = 0;
    AQError(
  ...
  if ((sysctlbyname("vm.stats.vm.v_cache_count", &cached_mem, &len, NULL, 0) ==
       -1) ||
      !len) {
    cached_mem = 0;
    AQError(
...
QStringList System_Info::Get_Host_FDD_List()
{
  ...
  QDir dev_dir("/dev/fd/");
  QFileInfoList devices =
      dev_dir.entryInfoList(QStringList("*"), QDir::System, QDir::Name);
...
QStringList System_Info::Get_Host_CDROM_List()
{
  ...
  QDir dev_dir("/dev/");
  QFileInfoList devices =
      dev_dir.entryInfoList(QStringList("acd*"), QDir::System, QDir::Name);
...
bool System_Info::Update_Host_USB()
{
  AQError("System_Info::Update_Host_USB()", "Not implemented!");
  return false;
}
...
void System_Info::Get_Free_Memory_Size(int& allRAM, int& freeRAM)
{
  ...
  double all_ram = vmstat.wire_count + vmstat.active_count +
